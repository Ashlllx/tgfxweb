...
[<font color=#005AD9>源码</font>](/docs/terms.html#源码)下载后需要拉取第三方库依赖
...
### Demo工程
  ...
  在 linux 目录下
   ```
    ...
    ./pag-linux
 ```
   Demo工 程仅仅提供了库文件的编译和简单的使用范例，如果需要[<font color=blue>占位图</font>](/docs/terms.html#占位图)填充视频或者导出视频，需要使用者自行开发
