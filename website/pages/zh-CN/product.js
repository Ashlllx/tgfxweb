...
class Button extends React.Component {
  render() {
    const { text, img, blue, link, className, style = {}, id = '' } = this.props;
    return (
      <a id={id} href={link} class={'btn ' + (blue ? 'blue' : 'white') + (className ? ` ${className} ` : '')} style={style}>
          ...
          <div className="section-content">
            <div className="section-top">
              ...
              <SectionDesc
                ...
                leftBtnLink="/zh-CN/feature.html"
                rightBtnText="Github"
          ...
          <div className="section-content">
            <div className="section-top">
              ...
              <SectionDesc
                ...
                leftBtnLink="/docs/zh-CN/TAVMedia-SDK-product-Introduction.html"
                leftBtnWidth={124}
                rightBtnTooltip={true}
              />
            </div>
